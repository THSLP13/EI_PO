...
#if LV_USE_FS_STDIO
#define LV_FS_STDIO_LETTER 'H'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
...
#if LV_USE_FS_WIN32
#define LV_FS_WIN32_LETTER  'H'    /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
